      ...
      <div className="contactus">
        <div className="social">
          <Link to="https://www.facebook.com/teamhorizoncusat/" target="_blank">
            <FontAwesomeIcon icon={faFacebook} title="facebook" /> share!
          </Link>
        </div>
        <div className="social">
          <Link
            ...
            target="_blank"
          >
            <FontAwesomeIcon icon={faInstagram} title="Instagram" /> follow
          </Link>
        </div>
        <div className="social">
          <Link
            ...
            target="_blank"
          >
            <FontAwesomeIcon icon={faLinkedin} title="LinkedIn" /> connect
          </Link>
        </div>
        <div className="social">
          <Link to="https://youtu.be/yEy-2Nw_Bh4" target="_blank">
            <FontAwesomeIcon icon={faYoutube} title="youtube" /> watch
          </Link>
        </div>
      </div>
