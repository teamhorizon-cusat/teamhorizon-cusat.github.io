...
export default function Hero() {
  return (
    <Container>
      <Row id="hero-row">
        <Col md={6}>
          <h1 className="display-1" id="hero-head">
            Team Horizon
          </h1>
          <p className="h3 text-center" id="head-subtitle">
            Building next gen Rovers that'll roam on Mars and Beyond!
          </p>
        </Col>
        <Col md={6}>
