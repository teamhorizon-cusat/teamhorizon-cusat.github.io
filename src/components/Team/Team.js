       ...
       <Container id="team">
           ...
           <Container id="team-card">
               ...
               <div id={`image-container3${t2?'-animate':''}`}>
                    <Image src={af} alt="the freaking awesome team members" id="team-img" />
                    <h4>Aftab Mehrab</h4>
                    <p>Team manager | outreach head</p>
                    <p><a href="mailto:aftab.s@ug.cusat.ac.in" aria-label="button for emailing team member"><Envelope/></a>
                    <a href="https://www.linkedin.com/in/aftab-s-9b69571a3" aria-label="linked in link"><Linkedin/></a></p>
                </div>
               </ScrollTrigger>
               ...
               <ScrollTrigger onEnter={onEnterViewport8} onExit={onExitViewport8} aria-label="animation for team">
